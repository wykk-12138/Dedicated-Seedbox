...
source <(wget -qO- https://raw.githubusercontent.com/wykk-12138/Seedbox-Components/main/seedbox_installation.sh)
...
source <(wget -qO- https://raw.githubusercontent.com/wykk-12138/bash_loading_animations/main/bash_loading_animations.sh)
...
while getopts "u:p:c:q:l:rbvx3oh" opt; do
  case ${opt} in
	...
	h ) # process option help
		...
		source <(wget -qO- https://raw.githubusercontent.com/wykk-12138/Seedbox-Components/main/Torrent%20Clients/qBittorrent/qBittorrent_install.sh)
		seperator
		info "Options:"
